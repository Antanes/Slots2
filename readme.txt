...
В папке Models/Domain хранятся модель напитков Drinks. В папке Models/ViewModel содержится модель представления. В файле ApplicationDbContext описано взаимодействие с базой данных.
