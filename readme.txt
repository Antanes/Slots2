...
В папке Models/Domain хранятся модель напитков Drinks и модель автомата(покупки) Machine. В папке Models/ViewModel содержится модель представления. В файле ApplicationDbContext описано взаимодействие с базой данных.
